...
class ApiTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->api->setDebug(true, dirname(__FILE__) . '/../../../src/logs/barzahlen.log');
    }
    ...
    public function testHandleRequest()
    {
        ...
        $request = $this->getMock('Barzahlen_Request_Cancel', array('buildRequestArray', 'parseXml'), array('7691945'));
